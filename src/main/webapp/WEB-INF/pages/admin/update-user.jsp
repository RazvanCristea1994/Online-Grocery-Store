...
<form:form method="PUT" action="http://localhost:8080/Rzv_war/admin/update-user/${email}" modelAttribute="user">
    <table>
        <tr>
        ...
        <tr>
            <td>
                <button onclick="location.href = 'http://localhost:8080/Rzv_war/admin/delete-account'">Delete Account</button>
            </td>
        </tr>
    </table>
...
<div>
    <button type="button" name="back" onclick="location.href = '${pageContext.request.contextPath}/admin'">Back to all users</button>
</div>
</body>
</html>
